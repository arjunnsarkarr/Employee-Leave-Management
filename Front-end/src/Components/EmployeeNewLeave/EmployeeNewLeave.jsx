...
const EmployeeNewLeave = () => {
  ...
  const [particularLeave, setParticularLeave] = useState({});
    ...
    <>
      ...
      <div className="dataTable container mt-5 mb-5">
        <div className="d-flex justify-content-between align-items-center">
          <h4 className="mb-4">Employee New Leave Applications </h4>
          <input
            type="text"
...
export default EmployeeNewLeave;
